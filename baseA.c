...
int main(int argc, const char * argv[]) {
    ...
    char filename[500];
    sprintf(filename, "log/fig2A/outfileA_K_%d_memory_%f_BWE1_%f_BM1E1_%f_BM2E1_%f_mutationAa_%f_N1000.txt", K, p, BIRTH_RATE_W_E1, BIRTH_RATE_M1_E1, BIRTH_RATE_M2_E1, mutationAa);
