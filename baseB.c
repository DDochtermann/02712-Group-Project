...
int main(int argc, const char * argv[]) {
    ...
    for (run=0; run<NRRUNS; run++){
        ...
        double theRates[8]={B_rate_A, D_rate_A, B_rate_M1, B_rate_M2, D_rate_M1, D_rate_M2};
    ...
    char filename[500];
    sprintf(filename, "log/fig2B/outfileB_K_%d_memory_%f_BWE1_%f_BM1E1_%f_BM2E1_%f_mutationAa_%f_N1000.txt", K, p, BIRTH_RATE_W_E1, BIRTH_RATE_M1_E1, BIRTH_RATE_M2_E1, mutationAa);
